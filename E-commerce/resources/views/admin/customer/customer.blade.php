            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$value->address}}</td>
                        <td>
                        <a onclick="return confirm('Bạn có chắc chắn muốn xoá bình luận?')" href = "{{route('delete_customer', ['id'=>$value->id])}}" class="" id=''><i class = 'fa fa-trash' style="font-size: 28px;color:red"></i></a>
                    ...
                    <table>
                        ...
                        <div class = 'pagination justify-content-center'>{!! $customer->links() !!}</div>
