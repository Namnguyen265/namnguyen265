            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cây</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="col-12">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <table>
                        ...
                        <div class = 'pagination justify-content-center'>{!! $product->links() !!}</div>
    ...
    <td>
        <a href="{{route('create_product')}}"><button class = 'btn btn-success' name = '' type = 'submit'>Thêm mới</button></a>
    </td>
</div>
</div>
</div>
