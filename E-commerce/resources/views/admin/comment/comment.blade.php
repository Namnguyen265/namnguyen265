...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Bình luận về cây</h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Bình luận về cây</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a onclick="return confirm('Bạn có chắc chắn muốn xoá bình luận?')" href = "{{route('delete_product_comment', ['id'=>$value->id_comment])}}" class="" id=''><i class = 'fa fa-trash' style="font-size: 28px;color:red"></i></a>
                    ...
                    <table>
                        ...
                        <div class = 'pagination justify-content-center'>{!! $comment->links() !!}</div>
